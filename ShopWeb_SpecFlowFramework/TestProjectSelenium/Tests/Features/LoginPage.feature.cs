...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="User successful login")]
        [Xunit.TraitAttribute("FeatureTitle", "LoginPage")]
        [Xunit.TraitAttribute("Description", "User successful login")]
        [Xunit.TraitAttribute("Category", "Smoke")]
        [Xunit.TraitAttribute("Category", "FullRegression")]
        public virtual void UserSuccessfulLogin()
        {
            string[] tagsOfScenario = new string[] {
                    "Smoke",
                    "FullRegression"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("User successful login", null, new string[] {
                        "Smoke",
                        "FullRegression"});
#line 5
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 6
 testRunner.When("I assign \'4\' testrail case Id", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 7
